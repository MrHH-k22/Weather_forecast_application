...
function AddCityPage() {
    ...
    if (cityName !== undefined) {
        ...
        const allTemps = [...maxTempChartData.map(d => d.value), ...minTempChartData.map(d => d.value)];
        ...
        return (
            <View className="flex-1 p-4 bg-white-100 ">
                    ...
                    >
                        <View>
                            ...
                            <View className="flex-row mt-0">
                                {dailyData.map((item, index) => (
                                    <View key={index} style={{ width: dayWidth }}>
                                        <Text className="text-gray-500">{item.maxWind.toFixed(1)} km/h</Text>
                                    </View>
                                ))}
                            </View>
                        </View>
                ...
                <View className="items-center justify-center">
                    ...
                    >
                        <Feather name={isFavorite ? "chevron-right" : "plus"} size={24} color="white" />
                    </TouchableOpacity>
                </View>
                <View>
